...
The activity endpoints use cursor-based pagination for stable ordering.

### Cursor Format

`base64(ledger_sequence:event_index)`

Example: `MTAwMDow` = `1000:0`

### Requesting Pages

```bash
# First page
curl "https://api.stellarlend.io/lending/activity?limit=20"

# Next page
curl "https://api.stellarlend.io/lending/activity?cursor=MTAwMDow&limit=20"
...
| --------- | ------ | ------- | ------------------------- |
| `cursor`  | string | —       | Start after this position |
...
Stable ordering even as new events arrive

See docs/ACTIVITY_ORDERING_GUARANTEES.md for full details.
...
|------|--------|-------------|
| `api/src/utils/cursor.ts` | **NEW** | Cursor encode/decode/compare utilities |
| `api/src/utils/cursor.test.ts` | **NEW** | Cursor utility tests (100% coverage) |
| `api/src/services/stellar.service.ts` | **UPDATED** | Added ledger range fetching + event ordering |
| `api/src/services/stellar.service.test.ts` | **NEW** | StellarService tests |
| `api/src/controllers/lending.controller.ts` | **UPDATED** | Cursor parsing, emission, pagination logic |
| `api/src/__tests__/lending.controller.test.ts` | **NEW** | Controller tests (13 cases, 95%+ coverage) |
| `docs/ACTIVITY_ORDERING_GUARANTEES.md` | **NEW** | Ordering guarantees documentation |
| `api/README.md` | **UPDATED** | Added pagination documentation |
...
# Specific test files
npx jest api/src/utils/cursor.test.ts
npx jest api/src/__tests__/lending.controller.test.ts
npx jest api/src/services/stellar.service.test.ts