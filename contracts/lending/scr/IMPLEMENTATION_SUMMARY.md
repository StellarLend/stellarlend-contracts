...
This document summarizes the implementation of reserve invariant checking for the Stellar lending contracts.
...
The implementation provides a robust safety net that will catch accounting bugs, reentrancy attacks, and balance manipulation attempts before they can cause system-wide damage.
